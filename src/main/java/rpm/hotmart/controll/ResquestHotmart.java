...
public class ResquestHotmart {
	...
	private static List<Product> parseJsonProdutosToObject(JSONObject jSONObject, List<Product> produtos) {
	...
	private static boolean filterProduct(Product produto) {
	...
	private static JSONObject affiliationRequest(Product produto, String userSessionId) {
